...
print(type(of: primary2))   // Optional<School>:: 원시 값으로 인스턴스가 생성되었기 때문에 Optional<Type Name> 출력
print(type(of: graduate))   // Optional<School>:: 원시 값으로 인스턴스가 생성되었기 때문에 Optional<Type Name> 출력
